...
import com.example.eduardocucharro.reediteye.data.FakeReeditApi;
...
import com.example.eduardocucharro.reediteye.util.FakeCacheImpl;
...
public class Injector {
    ...
    public static CacheService provideCacheService() {
        if(cacheService == null) {
            cacheService = new FakeCacheImpl();
        }
